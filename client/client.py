...
def generate_csr():
    ...
    csr = x509.CertificateSigningRequestBuilder().subject_name(
        x509.Name([
            x509.NameAttribute(x509.oid.NameOID.COUNTRY_NAME, u"UK"),
            x509.NameAttribute(x509.oid.NameOID.STATE_OR_PROVINCE_NAME, u"Cumbria"),
            x509.NameAttribute(x509.oid.NameOID.LOCALITY_NAME, u"Keswick"),
            x509.NameAttribute(x509.oid.NameOID.ORGANIZATION_NAME, u"PavInc"),
            x509.NameAttribute(x509.oid.NameOID.COMMON_NAME, u"github.com/actuallypav"),
        ])
